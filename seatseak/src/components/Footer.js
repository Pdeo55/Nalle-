    ...
    <footer className="contianer  pt-5">
      <section id="main" className="px-5">
        ...
        <div id="footer-coloumn3" className="col-lg-4 col-sm-12 coloumn">
          ...
          <div id="social">
            <a href="#" id="social-facebook"><FaFacebookF size={25} className="mt-2 text-light text-center" /></a>
            <a href="#" id="social-twitter"><FaTwitter size={25} className="mt-2 text-light text-center" /></a>
            <a href="#" id="social-instagram"><FaInstagram size={25} className="mt-2 text-light text-center" /></a>
          </div>
        </div>
      </section>
